...
if(!function_exists('is_plugin_active') || function_exists('is_plugin_active') && is_plugin_active("mf_base/index.php"))
{
	...
	function uninstall_navigation()
	{
		...
		mf_uninstall_plugin(array(
			'options' => array('setting_navigation_background_color', 'setting_navigation_text_color', 'setting_navigation_container_padding_mobile', 'setting_navigation_item_border_margin_left', 'setting_navigation_item_border_margin_right', 'setting_navigation_item_vertical_padding_left', 'setting_navigation_item_border_radius', 'setting_navigation_item_padding', 'setting_navigation_item_padding_vertical', 'setting_navigation_item_padding_mobile', 'setting_navigation_breakpoint_tablet', 'setting_navigation_breakpoint_mobile', 'option_navigation_logged_in_cookies', 'setting_navigation_logged_in_cookies'),
		));
	}
}